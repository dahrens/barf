        ...
        <nav class="panel">
          ...
          <template v-for="ingredientMeta in ingredientStash">
            <a v-on:click="activateStashItem(ingredientMeta.item)" class="panel-block" :class="{'is-active': isActiveStashItem(ingredientMeta.item)}">
              <p class="panel-icon">
                <fa v-if ="!isActiveStashItem(ingredientMeta.item)" pack="fas" name="chevron-right" />
                <fa v-if ="isActiveStashItem(ingredientMeta.item)" pack="fas" name="chevron-down" />
              </p>
          ...
          <template v-for="recipeMeta of recipeStash">
            <a v-on:click="activateStashItem(recipeMeta.recipe)" class="panel-block" :class="{'is-active': isActiveStashItem(recipeMeta.recipe)}">
              <p class="panel-icon">
                <fa v-if ="!isActiveStashItem(recipeMeta.recipe)" pack="fas" name="chevron-right" />
                <fa v-if ="isActiveStashItem(recipeMeta.recipe)" pack="fas" name="chevron-down" />
              </p>
